    ...
    <Card className="mt-6 border border-cyan/10 shadow-elegant">
      <CardHeader className="px-4 sm:px-6 py-4 border-b border-cyan/10">
        ...
        <CardDescription className="text-[13px] sm:text-[14px] font-light mt-1 text-navy/60">
          Crie, renomeie e remova categorias usadas para organizar os documentos.
        </CardDescription>
      </CardHeader>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(open) => !open && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja remover esta categoria? Categorias em uso por documentos não poderão ser removidas.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
