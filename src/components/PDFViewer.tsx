    ...
    const fetchPdfAsBlob = async () => {
      try {
        ...
        if (error.message.includes('400')) {
          errorMessage = "Arquivo não encontrado ou URL inválida. Verifique se o relatório existe.";
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8">
              <div className="max-w-4xl w-full bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-6 sm:p-12 space-y-6">
                ...
                <div className="mt-8 pt-6 border-t border-cyan/20 flex items-center justify-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span>
                    Este relatório está protegido. Cópia, impressão e downloads estão desabilitados.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm z-10">
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-muted-foreground">
                    {isFetchingPdf ? "Carregando PDF..." : "Renderizando relatório..."}
                  </p>
                </div>
              </div>
            )}
