-- ==========================================
-- PHASE 7: Admin Statistics & Analytics (ONLY)
-- ==========================================
...
AS $$
  SELECT json_build_object(
    ...
    'users_by_role', (
      SELECT COALESCE(json_object_agg(role, count), '{}'::json)
      FROM (
    ...
    'users_by_plan', (
      SELECT COALESCE(json_object_agg(plan_name, count), '{}'::json)
      FROM (
...
AS $$
  SELECT json_build_object(
    ...
    'topics_by_category', (
      SELECT COALESCE(json_object_agg(category_name, count), '{}'::json)
      FROM (
