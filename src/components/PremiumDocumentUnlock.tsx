    ...
    return (
      <Card className="max-w-2xl mx-auto mt-8">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Este é um relatório premium exclusivo
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card className="max-w-2xl mx-auto mt-8">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Avalie este relatório para ter acesso completo ao conteúdo
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {previewImageUrl && (
        ...
        <div className="bg-muted/50 rounded-lg p-6 space-y-4">
          <div className="text-center space-y-2">
            <h3 className="font-semibold text-lg">Como você avalia este relatório?</h3>
        ...
        <p className="text-xs text-center text-muted-foreground">
          Após avaliar, você terá acesso permanente a este relatório
        </p>
      </CardContent>
    </Card>
  );
